...
class CreateSysUserLevelsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sys_user_levels', function (Blueprint $table) {
            ...
            $table->integer('parent_level_id',4)->autoIncrement(false)->nullable(true);
            $table->tinyInteger('min_username_length',2)->autoIncrement(false)->nullable(true)->default(8);
            $table->tinyInteger('max_username_length',2)->autoIncrement(false)->nullable(true)->default(25);
            $table->tinyInteger('multi_login_allow',1)->autoIncrement(false)->nullable(false)->default(0);
            $table->tinyInteger('max_wrong_login_attemp',1)->autoIncrement(false)->nullable(false)->default(3);
