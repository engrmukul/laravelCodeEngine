...
function fileUploadHtml($multiple = false, $reference = '', $reference_id = '')
{
                ...
                if ($rows->count() > 0) {
                    ...
                    foreach ($rows as $row) {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a title="View" target="_blank" class="btn btn-info btn-xs" href="<?php echo url($row->document_path); ?>"><i class="fa fa-eye"></i></a></td>
    ...
    <script type="text/javascript">
      ...
      <td class="text-center"><button title="Remove" type="button" class="btn btn-danger btn-sm attach_remove"><i class="fa fa-remove"></i></button></td>\n\
        ...
        $(document).on('click', '.attach_remove_ajax', function(){
            var $this = $(this);
