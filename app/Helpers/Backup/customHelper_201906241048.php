    ...
    <tbody>
      ...
      if (!empty($reference) && !empty($reference_id)) {
        ...
        <tr>
          ...
          <td class="text-center"><a title="View" class="btn btn-primary btn-xs" href="<?php echo url($row->document_path); ?>"><i class="fa fa-eye"></i></a></td>
  ...
  <table class="table table-bordered table-condensed" id="attach_table_view">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-left"><?php echo $row->document_name; ?></td>
        <td class="text-center"><a download title="Download" class="btn btn-primary btn-xs" href="<?php echo url($row->document_path); ?>"><i class="fa fa-download"></i></a></td>
      </tr>
      <?php
        }
      } else {
